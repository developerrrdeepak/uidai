...
BIO_FILE = os.path.join(DATA_DIR, 'aadhaar_biometric_cleaned.csv')
DEMO_FILE = os.path.join(DATA_DIR, 'aadhaar_demographic_cleaned.csv')
...
if __name__ == '__main__':
    print("Starting UIDAI Dashboard API...")
