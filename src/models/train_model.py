...
try:
    bio_df = pd.read_csv('data/cleaned/aadhaar_biometric_cleaned.csv')
    demo_df = pd.read_csv('data/cleaned/aadhaar_demographic_cleaned.csv')
    print(f"✓ Biometric data: {len(bio_df)} rows")
    print(f"✓ Demographic data: {len(demo_df)} rows")
    
    # Load enrollment data
    enrol_files = ['data/raw/api_data_aadhar_enrolment_0_500000.csv', 'data/raw/api_data_aadhar_enrolment_500000_1000000.csv', 'data/raw/api_data_aadhar_enrolment_1000000_1006029.csv']
    enrol_dfs = []
