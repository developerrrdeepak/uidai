...
files=['data/raw/api_data_aadhar_enrolment_0_500000.csv', 'data/raw/api_data_aadhar_enrolment_500000_1000000.csv', 'data/raw/api_data_aadhar_enrolment_1000000_1006029.csv']
...
# Save to CSV
enrollment_clean.to_csv('data/cleaned/aadhaar_enrollment_cleaned.csv', index=False)
