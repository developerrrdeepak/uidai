...
if __name__ == "__main__":
    ...
    demo_file = "aadhaar_demographic_cleaned.csv"
    ...
    # Load biometric data
    bio_file = "aadhaar_biometric_cleaned.csv"
    ...
    try:
        ...
        if os.path.exists('eda_charts.png'):
            img = mpimg.imread('eda_charts.png')
        ...
        if os.path.exists('eda_charts_biometric.png'):
            img = mpimg.imread('eda_charts_biometric.png')
            plt.figure(figsize=(12, 8))
            plt.imshow(img)
            plt.axis('off')
